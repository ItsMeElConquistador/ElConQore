...
public class EQInstanceTransformer implements IClassTransformer {
	...
	public void addInstanceTransforms() {
		if(instanceTransforms.isEmpty()) {
			instanceTransforms.add(new InstanceTransform("net.minecraft.client.multiplayer.PlayerControllerMP", "biy", "net.minecraft.client.entity.EntityClientPlayerMP", "bje", "elcon.mods.core.player.PlayerCoreClient", 3));
			instanceTransforms.add(new InstanceTransform("net.minecraft.server.management.ServerConfigurationManager", "ld", "net.minecraft.entity.player.EntityPlayerMP", "mn", "elcon.mods.core.player.PlayerCoreServer", 0));
			instanceTransforms.add(new InstanceTransform("net.minecraft.client.renderer.entity.RenderManager", "bnf", "net.minecraft.client.renderer.entity.RenderPlayer", "boh", "elcon.mods.core.player.PlayerCoreRender", 3));
